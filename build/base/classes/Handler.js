...
class Handler {
    ...
    LoadInteractions() {
        return __awaiter(this, void 0, void 0, function* () {
            const files = (yield (0, glob_1.glob)(`build/interactions/**/*.js`)).map((filePath) => path_1.default.resolve(filePath));
            files.map((file) => __awaiter(this, void 0, void 0, function* () {
                const interaction = new (yield Promise.resolve(`${file}`).then(s => __importStar(require(s)))).default(this.client);
                if (!interaction.name) {
                    return delete require.cache[require.resolve(file)] && console.log(`${file.split("/").pop()} does not have a name.`);
                }
